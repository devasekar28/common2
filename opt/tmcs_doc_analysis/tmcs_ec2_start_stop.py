...
#Usage: python3 ec2_start_stop.py start|stop|status 
#Example: python3 ec2_start_stop.py start  --> this will start  instance 
# Name	         : start_iot_demo.sh
# Pupose         : To start/stop IOT instances based on the given arguments
# DATE           : Mon Dec 18 07:30:43 UTC 2017
# Python Version : 3.4
...
project_name = 'TMCS'
usage = "sudo python3.4 tmcs_ec2_start_stop.py start|stop|status"
instance_id = 'i-0463c4b68ceb68235'
region = "us-west-2" 
start_msg = 'starting' + ' ' + project_name + ' ' + 'instance'
stop_msg = 'stopping' + ' ' + project_name + ' ' +'instance'
user = os.environ['SUDO_USER']
TO = ['devops@orzota.com','anitha.m@orzota.com','vishnu.pb@orzota.com','aberami.g@orzota.com']
