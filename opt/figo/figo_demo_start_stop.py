...
project_name = 'Figo Demo 54.69.121.198'
usage = "python3.4 insurance_ec2_start_stop.py start|stop|status"
instance_id = 'i-0682f1c03154435b2'
#os.system("aws ec2 describe-instances --instance-id -0682f1c03154435b2 --query 'Reservations[*].Instances[*].PublicIpAddress' > out.txt")
#reader = open("out.txt")
region = "us-west-2" 
