...
project_name = 'Figo Dev server 52.43.232.26'
usage = "python3.4 insurance_ec2_start_stop.py start|stop|status"
instance_id = 'i-05c8ce827cae673ae'
#os.system("aws ec2 describe-instances --instance-id i-05c8ce827cae673ae --query 'Reservations[*].Instances[*].PublicIpAddress' > out.txt")
#reader = open("out.txt")
region = "us-west-2" 
