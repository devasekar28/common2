...
#Usage: sudo /bin/python3.4 /opt/iot_client/iotclient_spot.py  create|terminate
...
# DATE           : Fri Dec  8 10:30:27 UTC 2017
# Python Version : 3.4
...
if len(sys.argv) < 2:
    print ("usage: sudo python3.4 /opt/iot_client/iotclient_spot.py create|terminate")
