...
project_name = 'insurance_claims'
usage = "python3.4 insurance_ec2_start_stop.py start|stop"
instance_id = 'i-0dd03a00045d3566a'
region = "us-west-2" 
start_msg = 'starting' + ' ' + project_name + ' ' + 'instance'
stop_msg = 'stopping' + ' ' + project_name + ' ' +'instance'
user = os.environ['SUDO_USER']
TO = ['devops@orzota.com','anitha.m@orzota.com','aberami.g@orzota.com','sreemathan.r@orzota.com','dharmin@orzota.com']
