...
project_name = 'Aqmd-Iot-Test 52.89.58.19'
usage = "python3.4 insurance_ec2_start_stop.py start|stop|status"
instance_id = 'i-01b2ed5649feb9577'
#public_ip = 52.89.58.19
#os.system("aws ec2 describe-instances --instance-id i-01b2ed5649feb9577 --query 'Reservations[*].Instances[*].PublicIpAddress' > out.txt")
#reader = open("out.txt")
