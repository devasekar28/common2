...
project_name = 'AQMD_RUL_Demo 52.13.215.169'
usage = "python3.4 insurance_ec2_start_stop.py start|stop|status"
instance_id = 'i-09bb70f49ce9bbdfc'
#os.system("aws ec2 describe-instances --instance-id i-09bb70f49ce9bbdfc --query 'Reservations[*].Instances[*].PublicIpAddress' > out.txt")
#reader = open("out.txt")
region = "us-west-2" 
