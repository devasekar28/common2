...
project_name = 'Iot-Demo-Project'
usage = "python3.4 insurance_ec2_start_stop.py start|stop|status"
instance_id = 'i-038ea864edf927873'
region = "us-east-1" 
start_msg = 'starting' + ' ' + project_name + ' ' + 'instance'
stop_msg = 'stopping' + ' ' + project_name + ' ' +'instance'
user = os.environ['SUDO_USER']
TO = ['karthigeyan@orzota.com','vishnu.pb@orzota.com','devops@orzota.com','aberami.g@orzota.com','anitha.m@orzota.com']
