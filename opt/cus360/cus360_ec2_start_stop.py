...
project_name = 'cus360 52.22.128.255'
usage = "python3.4 cus360_ec2_start_stop.py start|stop|status"
instance_id = 'i-089298f8001f27bb2'
region = "us-east-1" 
...
def send_mail(TEXT,TEXT1):
    SUBJECT = project_name + '52.22.128.255 Instance Start/Stop Alert'
