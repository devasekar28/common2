...
project_name = 'Solr&Zookeeper'
usage = "python3.4 insurance_ec2_start_stop.py start|stop|status"
instance_id = 'i-093f0b81f1cb25ac3'
region = "us-east-2" 
start_msg = 'starting' + ' ' + project_name + ' ' + 'instance'
stop_msg = 'stopping' + ' ' + project_name + ' ' +'instance'
user = os.environ['SUDO_USER']
TO = ['venkata@orzota.com','deva@orzota.com','ayyanar@orzota.com','karthigeyan@orzota.com','anitha.m@orzota.com','aberami.g@orzota.com','sreemathan.r@orzota.com','dharmin@orzota.com','vishnu.pb@orzota.com']
