...
project_name = 'Telit-Client-access-instancei 35.163.68.70'
#pub_ip = '35.163.68.70'
usage = "python3.4 tellit-service-start-stop.py start|stop|status"
...
def send_mail(TEXT,TEXT1):
    SUBJECT = project_name + pub_ip + 'Instance Start/Stop Alert'
